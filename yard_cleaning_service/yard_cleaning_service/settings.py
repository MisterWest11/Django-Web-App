"""
Django settings for yard_cleaning_service project.
...
SECRET_KEY = 'django-insecure-@lcte+mb#rhhz7-79n4rf!fox!+^2ya(4j0j901dx56%@yw@8_'
...
INSTALLED_APPS = [
    ...
    'yardapp',
    'widget_tweaks', # Add the widget_tweaks app
]

AUTHENTICATION_BACKENDS = [
    'yardapp.auth_backend.EmailAuthBackend', # Add the custom authentication backend
...
ROOT_URLCONF = 'yard_cleaning_service.urls'
...
WSGI_APPLICATION = 'yard_cleaning_service.wsgi.application'
